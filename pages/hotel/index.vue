<template>
  <section class="container">
    ...
    <div v-if="hotelsList.data[0]">
      <div class="hotelDetails" v-for="(item,index) in hotelsList.data" 
      :key="index" 
      @click="$router.push(`/hotel/${item.id}`)">
        ...
        <div class="middle">
          ...
          <div>
            ...
            <i v-if="item.hotellevel">
                ...
                v-for="(v,i) in item.hotellevel.level"
                :key="i"
                ></i>
            </i>
              {{item.hoteltype.name}}
        ...
        <div class="right">
          <div @click="$router.push()" class="onlineShopping" v-for="(product,index) in item.products" :key="index">
